...
class Post_screen_firestore extends StatefulWidget {
  const Post_screen_firestore({Key? key}) : super(key: key);
...
class _Post_screen_firestoreState extends State<Post_screen_firestore> {
  ...
  Widget build(BuildContext context) {
    ...
    var mheight = MediaQuery
        ...
        .height;
    return Scaffold(
        appBar: AppBar(title: Text('FirebaseFirestore',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
